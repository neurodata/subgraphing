...
Due to consistency, we expect that as n increases we should get closer and closer approximations of alpha, beta. and as such the difference between the estimated and true alpha, beta should decline. 
